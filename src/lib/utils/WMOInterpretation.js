...
const WMOInterpretation = flattenObject({
    "0,1": {
        ...
        icon: { day: "sunny", night: "moon" }
    },
    "2": {
        name: "Partly cloudy",
        color: { day: "#FFD23F", night: "#F6F1D5" },
        icon: { day: "cloudy_sun", night: "cloudy_moond" }
    },
    "3": {
        name: "Overcast",
    ...
    "65,67": {
        name: "Heavy rain",
        color: { day: "#3048C9", night: "#3048C9" },
        icon: { day: "heavy_rain", nigt: "heavy_rain" }
    },
    "71,73,77": {
        name: "Snow fall",
        color: { day: "#D6F5FF", night: "#D6F5FF" },
        icon: { day: "snow", nigt: "snow" }
    },
    "75": {
        name: "Heavy snow",
        color: { day: "#D6F5FF", night: "#D6F5FF" },
        icon: { day: "snow_heavy", nigt: "snow_heavy" }
    },
    "80,81,82": {
        name: "Rain showers",
        color: { day: "#1DA5CF", night: "#1DA5CF" },
        icon: { day: "rain_cloud", nigt: "rain_cloud" }
    },
    "85,86": {
        name: "Heavy snow",
        color: { day: "#D6F5FF", night: "#D6F5FF" },
        icon: { day: "snow_cloud", nigt: "snow_cloud" }
    },
    "95,96,99": {
        name: "Thunderstorm",
        color: { day: "#3048C9", night: "#3048C9" },
        icon: { day: "thunder", nigt: "thunder" }
    }
});
